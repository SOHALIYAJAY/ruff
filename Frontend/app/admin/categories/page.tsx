...
export default function CategoriesPage() {
  ...
  const [form, setForm] = useState({ name: '', code: '', description: '', department: '', slaValue: '', slaUnit: 'Hours', priority: 'Medium', active: true })
  ...
  async function createCategory() {
    try {
      ...
      setForm({ name: '', code: '', description: '', department: '', slaValue: '', slaUnit: 'Hours', priority: 'Medium', active: true })
    } catch (e: any) {
  ...
  const filteredCategories = categories.filter(cat => {
    ...
    const status = (cat.status || '').toString()
    const dept = (cat.department || '').toString()
    const priority = (cat.priority || '').toString()
    ...
    if (sortBy === 'complaints') {
      return sortOrder === 'desc' ? b.complaints - a.complaints : a.complaints - b.complaints
    }
    if (sortBy === 'name') {
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="md:col-span-2">
              ...
              <textarea placeholder="Brief description..." rows={3} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">SLA Duration</label>
              <div className="flex gap-2">
                <input type="number" placeholder="24" className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                ...
                <tr key={cat.id} className="border-b border-gray-200 hover:bg-blue-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button className="p-1.5 hover:bg-blue-100 rounded transition-colors" title="Edit" onClick={() => setEditingCategory(cat.id)}>
