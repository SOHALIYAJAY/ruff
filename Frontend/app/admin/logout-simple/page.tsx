...
export default function AdminLogoutSimple() {
          ...
          {isLoggingOut ? (
            ...
            <div className="text-center py-6">
              <div className="inline-flex items-center gap-3">
                <div className="w-5 h-5 border-2 border-blue-600 border-t-transparent border-r-transparent animate-spin"></div>
