...
import { LogOut, Shield, CheckCircle2, ArrowRight, User, Lock, Clock } from 'lucide-react'
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="text-white">
                  ...
                  <p className="text-blue-100">
                    {isLoggingOut ? 'Securing your admin session...' : 'Thank you for managing the system'}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      Please wait while we secure your admin session
                    </p>
                  </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                      ...
                      <div className="flex-1">
                        <div className="h-2 bg-indigo-200 rounded-full overflow-hidden">
                          <div className="h-full bg-indigo-600 rounded-full animate-pulse" style={{width: '80%'}}></div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-2">
                      Your admin session has been securely terminated
                    </p>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900">Redirecting to Login</h3>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                  >
                    Go to Login Now
          ...
          <div className="px-12 py-6 bg-gray-50 border-t border-gray-100">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-xs mt-1">
                Secure Management • Efficient Operations • System Integrity
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-xs mt-1">
                Your admin session has been securely terminated. All authentication data has been cleared from this device for your protection.
              </p>
            </div>
          </div>
        </div>
